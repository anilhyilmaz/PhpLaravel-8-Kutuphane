                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="#" class="grid">
                                        <div class="user_img"><img src="{{asset('assets')}}/admin/images/avatar1.jpg" alt=""></div>
                                ...
                                <li class="odd"><a href="#" class="grid">
                                        <div class="user_img"><img src="{{asset('assets')}}/admin/images/avatar2.jpg" alt=""></div>
                                        <div class="notification_desc">
                                ...
                                <li><a href="#" class="grid">
                                        <div class="user_img"><img src="{{asset('assets')}}/admin/images/avatar3.jpg" alt=""></div>
                                        <div class="notification_desc">
