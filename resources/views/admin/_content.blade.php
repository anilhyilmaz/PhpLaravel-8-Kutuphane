                                    ...
                                    <div class="inbox_chat">
                                        <div class="chat_list active_chat">
                                            <div class="chat_people">
                                                <div class="chat_img"> <img src="{{asset('assets')}}/admin/images/avatar5.jpg" alt="Alexander" class="img-fluid">
                                                </div>
                                                <div class="chat_ib">
                                        ...
                                        <div class="chat_list">
                                            <div class="chat_people">
                                                <div class="chat_img"> <img src="{{asset('assets')}}/admin/images/avatar3.jpg" alt="Anderson" class="img-fluid">
                                                </div>
                                                <div class="chat_ib">
                                        ...
                                        <div class="chat_list">
                                            <div class="chat_people">
                                                <div class="chat_img"> <img src="{{asset('assets')}}/admin/images/avatar5.jpg" alt="Isabella" class="img-fluid">
                                                </div>
                                                <div class="chat_ib">
                                        ...
                                        <div class="chat_list">
                                            <div class="chat_people">
                                                <div class="chat_img"> <img src="{{asset('assets')}}/admin/images/avatar4.jpg" alt="Charlotte" class="img-fluid">
                                                </div>
                                                <div class="chat_ib">
                                        ...
                                        <div class="chat_list">
                                            <div class="chat_people">
                                                <div class="chat_img"> <img src="{{asset('assets')}}/admin/images/avatar2.jpg" alt="Davidson" class="img-fluid">
                                                </div>
                                                <div class="chat_ib">
                                        ...
                                        <div class="chat_list">
                                            <div class="chat_people">
                                                <div class="chat_img"> <img src="{{asset('assets')}}/admin/images/avatar1.jpg" alt="Elexa ker" class="img-fluid">
                                                </div>
                                                <div class="chat_ib">
                                ...
                                <div class="mesgs">
                                    <div class="msg_history">
                                        <div class="incoming_msg">
                                            <div class="incoming_msg_img"> <img src="{{asset('assets')}}/admin/images/avatar5.jpg" alt="Alexander"
                                                                                class="img-fluid"> </div>
