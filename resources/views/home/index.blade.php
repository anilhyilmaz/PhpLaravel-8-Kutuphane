        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        <img src="{{asset('assets')}}/images/img1.jpg" alt="img">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        <img src="{{asset('assets')}}/images/img2.jpg" alt="img">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        <img src="{{asset('assets')}}/images/img3.jpg" alt="img">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="item">
                        <img src="{{asset('assets')}}/images/img4.jpg" alt="img">
                        <h3>wendy doniger</h3>
                        <h6><span class="price">$49</span> / <a href="#">Buy Now</a></h6>
                        <div class="hover">
                            <a href="product-single.html">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="item">
                        <img src="{{asset('assets')}}/images/r1.jpg" alt="img">
                ...
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="item">
                        <img src="{{asset('assets')}}/images/r2.jpg" alt="img">
                        <h3><a href="#">Keepers of the kalachakara</a></h3>
                        <h6><span class="price">$19</span> / <a href="#">Buy Now</a></h6>
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="item">
                        <img src="{{asset('assets')}}/images/r3.jpg" alt="img">
                        <h3><a href="#">Keepers of the kalachakara</a></h3>
                        <h6><span class="price">$19</span> / <a href="#">Buy Now</a></h6>
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="item">
                        <img src="{{asset('assets')}}/images/r4.jpg" alt="img">
                        <h3><a href="#">Keepers of the kalachakara</a></h3>
                        <h6><span class="price">$19</span> / <a href="#">Buy Now</a></h6>
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-4">
                    <div class="item">
                        <img src="{{asset('assets')}}/images/r5.jpg" alt="img">
                        <h3><a href="#">Keepers of the kalachakara</a></h3>
                        <h6><span class="price">$19</span> / <a href="#">Buy Now</a></h6>
                    </div>
                </div>
